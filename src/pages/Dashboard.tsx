      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Fuso horário: <span className="font-semibold text-slate-700">{user.timezone}</span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 bg-slate-50 p-1.5 rounded-2xl border border-slate-200">
          ...
          <div className="flex items-center gap-2 px-3 text-xs font-bold text-slate-700 font-mono">
          ...
          {!isToday && (
            <button
              onClick={handleToday}
              className="ml-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold transition-colors cursor-pointer"
            >
              Hoje
            </button>
          )}
